        ...
        {/* Title */}
          ...
          <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'  >
            ...
            <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
              <label htmlFor="images" className='flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 tarnsition cursor-pointer'>
              ...
              className='text-sm bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:mask-b-to-purple-700 active:scale-95
