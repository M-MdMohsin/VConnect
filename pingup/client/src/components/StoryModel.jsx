    ...
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
            ...
            <div className='flex mt-4 gap-2'>
                {
                    bgColors.map((color)=>(
                        <button className='w-6 h-6 rounded-full ring cursor-pointer' key={color}
            ...
            <div className='flex gap-2 mt-4'>
                ...
                className={`flex-1 flex items-center justify-center gap-2 p-2 cursor-pointer rounded ${mode === 'text' ? "bg-white text-black"
                    : "bg-zinc-800"}`}>
